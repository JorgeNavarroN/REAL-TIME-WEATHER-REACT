export const ItemCoincidence = ({ coord, cityName = 'City', country = 'PE', temp = '12', icon = '01d', handleClick }) => {
  return (
    <li onClick={() => handleClick(coord)} className="grid grid-cols-[1fr_auto] place-content-between p-5 items-center cursor-pointer hover:bg-cyan-950/50">
      <div className="flex flex-col">
        <label href="#" className="text-lg flex flex-row gap-3 truncate overflow-ellipsis cursor-pointer max-sm:text-sm">
          {`${cityName} - ${country}`}
