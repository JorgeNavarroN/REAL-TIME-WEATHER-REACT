...
function App() {
  ...
  const { res, resForecast, isOpen, inputRef, opacity, handleBuscar, handleOpen, handleClose } = useBuscador()
  ...
  return (
    <Background dateTime={dateTime} timezone={res.timezone}>
      ...
      {!isOpen && <BuscadorModal inputRef={inputRef} opacity={opacity} isOpen={isOpen} handleClose={handleClose} handleSearchLocation={handleBuscar} />}
    </Background>
  )
}
